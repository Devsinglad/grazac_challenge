...
import 'package:grazac_challenge/Home5.dart';
  ...
  required VoidCallback onClicked,
    ...
    ElevatedButton(
      style: ElevatedButton.styleFrom(
          primary: Colors.grey[50]?.withOpacity(0.1),
          shape: StadiumBorder(),
      ...
      builder: (_, controller) => Container(
        ...
        child: ListView(
          children: [
            ...
            Center(
              child: Text(
                'Upload a  clear picture of the utility bill',
                style: TextStyle(
                  fontSize: 15,
                  fontWeight: FontWeight.w400,
            ...
            GestureDetector(
              onTap: () {
                Navigator.push(
                    context, MaterialPageRoute(builder: (_) => Home5()));
              },
              child: Container(
                height: 50,
                width: 335,
